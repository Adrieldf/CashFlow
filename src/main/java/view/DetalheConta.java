...
public class DetalheConta extends javax.swing.JFrame {
	...
	public void atualizaDados() {
		...
		for (Parcela parcela : listaParcelas) {
			...
			Object[] dados = { parcela.getId(), renegociado ? renegociacao.getNovoValor() : parcela.getValor(),
					renegociado ? renegociacao.getNovaData() : parcela.getData(), pago, renegociado
						...
						.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
										layout.createSequentialGroup()
												...
												.addGap(38, 38, 38))
								.addGroup(layout.createSequentialGroup().addComponent(jLabel1).addGap(61, 61, 61)
										.addComponent(txt_idconta).addGap(33, 33, 33))))
				.addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
						layout.createSequentialGroup().addGap(103, 103, 103).addComponent(btnRenegociar)
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED,
										javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
								.addComponent(jButton1, javax.swing.GroupLayout.PREFERRED_SIZE, 93,
										javax.swing.GroupLayout.PREFERRED_SIZE)
								.addGap(103, 103, 103).addComponent(btnNovo2, javax.swing.GroupLayout.PREFERRED_SIZE,
		...
		layout.setVerticalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup().addGap(21, 21, 21)
						...
						.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(btnNovo2).addComponent(jButton1).addComponent(btnRenegociar))
						.addGap(38, 38, 38)));
	...
	private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton1ActionPerformed
		...
		Parcela parcela = facade.buscaParcelaPorCodigo(Integer.parseInt(grid.getValueAt(rowIndex, 0).toString()),
				this.idConta, this.idUsuario);
